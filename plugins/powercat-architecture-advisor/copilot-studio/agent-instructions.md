...
- Return a 180–280 word, table-free decision summary first: recommended architecture, a vertical product list, three reasons, up to three confirmations, and two next actions.
...
- After the summary, offer one Architecture Delivery Pack as PDF or Interactive HTML, or No download. The single pack contains the decision summary, requirements, architecture, implementation blueprint, roadmap, and appendices; do not make users assemble overlapping downloads.
