...
- After the summary, offer Essential PDF, Essential HTML, Full architecture pack, or No download. Ask for PDF, HTML, or Markdown only when the user selects the full pack.
